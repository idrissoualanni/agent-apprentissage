...
const TOOL_LABELS: Record<string, string> = {
  ...
  update_mastery: "Mastery",
  revision_plan: "Revision",
};

const TOOL_COLORS: Record<string, string> = {
  rag_retrieval: "text-blue-400",
  generate_quiz: "text-emerald-400",
  evaluate_feynman: "text-amber-400",
  create_artifact: "text-pink-400",
  web_search: "text-cyan-400",
  update_mastery: "text-orange-400",
  revision_plan: "text-purple-400",
};

const TOOL_BG: Record<string, string> = {
  rag_retrieval: "bg-blue-500/10",
  generate_quiz: "bg-emerald-500/10",
  evaluate_feynman: "bg-amber-500/10",
  create_artifact: "bg-pink-500/10",
  web_search: "bg-cyan-500/10",
